...
power = {"a": 999, "b": 888, "c": 666, "d": 900, "e": 789, "f": 999}
greater = list(filter(lambda k : k[1] > 800,power.items()))
print(type(power.items()))
print(power.items())
print(greater)
'''
'''members = {
...
fpower = {"a": 999, "b": 888, "c": 666, "d": 900, "e": 789, "f": 999}
for k,v in members
a = list(min(fpower,key = lambda k : fpower[k]))
print(a)'''
help(sorted)
#greater = list(filter(lambda k : k[1] > 800,power.items()))
#print(x)
